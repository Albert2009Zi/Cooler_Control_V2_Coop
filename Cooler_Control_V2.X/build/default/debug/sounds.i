...
void BeepsStateMachine(void){
 ...
 case 2:
          if (cnt0 >= 80){
             cnt0 = 0;
             if (stateMachineAllowTimeout == 0){
                 state = 0;
         }
            else if (stateMachineAllowTimeout == 1){
         state = 3;
         }
           }
        break;
...
void PlayAlert() {
   ...
   uint8_t howMuchTimesPlayShort = 0;
   uint8_t howMuchTimesPlayLong = 0;
   ...
   switch (soundState){
     case 0:
      if (prmFlags.errorUnderVoltage){
        howMuchTimesPlayShort = 2;
        howMuchTimesPlayLong = 1;
        }
     ...
     if (prmFlags.errorHighTemperature){
       howMuchTimesPlayShort = 3;
       howMuchTimesPlayLong = 0;
       }
